              ...
              <section className="mb-6">
                ...
                <div className="mt-3 flex flex-wrap gap-2">
                  {recentSearches.map(value => (
                    <div
                      key={value}
                      className="inline-flex items-center rounded-full border border-[var(--color-stone-light)] bg-[var(--color-paper-muted)] transition-all focus-within:ring-2 focus-within:ring-[var(--color-primary)] focus-within:border-[var(--color-primary)] hover:border-[var(--color-stone)]"
                    >
                      <button
                        type="button"
                        onClick={() => {
                        ...
                        className="flex min-h-9 items-center pl-3.5 pr-2 text-xs font-semibold text-[var(--color-ink-soft)] hover:text-[var(--color-primary-dark)] focus-visible:outline-none"
                      >
                        {value}
                      </button>
                      <button
                        ...
                        onClick={(e) => {
                          e.stopPropagation();
                          const next = recentSearches.filter(v => v !== value);
                          setRecentSearches(next);
                          try {
                            window.localStorage.setItem(RECENT_SEARCHES_KEY, JSON.stringify(next));
                          } catch {
                        ...
                        className="mr-1.5 flex size-6 items-center justify-center rounded-full text-[var(--color-ink-muted)] hover:bg-[var(--color-stone-light)] hover:text-[var(--color-danger)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-danger)]"
